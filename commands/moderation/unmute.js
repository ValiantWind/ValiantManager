...
module.exports = class UnmuteCommand extends Command {
  ...
  async run(message, args) {
    ...
    else return this.sendErrorMessage(message, 1, 'No mute role exists in this server ._.');
    ...
    if (!member.roles.cache.has(muteRoleId)) 
      return this.sendErrorMessage(message, 0, 'Provided member is not even muted how do you not know that smh');
